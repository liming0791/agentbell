...
最新已发布版本为
[`v0.3.0-rc.11`](https://github.com/liming0791/agentbell/releases/tag/v0.3.0-rc.11)
...
RC11 改由 bootstrap 直接停用 AgentBell 计划任务，清理严格匹配的升级残留，并验证或
修复缓存 Core 元数据，避免运行中 EXE 导致 `EPERM`。
...
RC11 包含 M2 的一次性绑定、完整 Channel 事务、stable Hook/Service bridge、
