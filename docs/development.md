...
- 状态：In progress；settings/policy、binding、Channel 事务、stable Hook/Service
  ...
  隔离 Linux container TLS/HTTPS E2E 与跨平台 workflow 已接通；真实新 RC、跨平台
  实机和独立跨主机证据仍未完成，不能作为 M2 产品交付。
- 详细任务、协议、依赖关系和退出证据见
