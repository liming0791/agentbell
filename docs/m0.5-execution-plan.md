...
| 项目 | 内容 |
| --- | --- |
| 状态 | Implemented；退出验收通过，发布 `v0.2.0-rc.2` Technical Preview |
...
| M05-503 | RC 与退出评审 | `v0.2.0-rc.2`、验收记录、已知限制 | 所有退出条件有证据链接；P0/P1 blocker 为零 | M05-501, M05-502 | 1.0d |
...
| PR-6 Hardening | M05-501～503 | 故障矩阵、实机记录和 `v0.2.0-rc.2` |
