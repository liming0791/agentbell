...
test("release staging leaves a verified draft before manual finalization", async () => {
  ...
  for (const required of [
    ...
    "name: agentbell-npm",
    "gh release download \"$RELEASE_TAG\"",
    "--pattern 'liming0791-agentbell-*.tgz'",
    "npm pack --workspace @liming0791/agentbell-hook-runtime",
    "npm pack --workspace @liming0791/agentbell-cli",
    "\"@liming0791/agentbell-hook-runtime\"",
    "publish_or_verify \"@liming0791/agentbell-cli\"",
